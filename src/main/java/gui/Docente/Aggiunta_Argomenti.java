...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        finestraArgomenti.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        ...
        AggiungiButton.setForeground(new Color(-525825));
        ...
        RimuoviButton.setForeground(new Color(-525825));
